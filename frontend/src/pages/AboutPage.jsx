...
import {
  HiCheckCircle, HiArrowRight, HiLightBulb, HiEye, HiHeart,
  HiTrendingUp, HiShieldCheck, HiStar, HiSparkles,
} from 'react-icons/hi';
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-background dark-grid">
        ...
        <div className="relative z-10 w-full max-w-5xl mx-auto px-4 text-center pt-32 pb-24">
          ...
          >
            NexCode is a premier software development firm dedicated to bridging the gap between ambitious product ideas and highly optimized, clean digital solutions. We engineer for scale, stability, and speed.
          </motion.p>
