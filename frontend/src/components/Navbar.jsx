...
const themeUi = {
  ...
  primary: {
    ...
    ctaBtn:
      "inline-flex items-center justify-center px-4 py-2 rounded-lg text-xs font-semibold bg-legacyPrimary-500 duration-200 transition-all text-white/80 hover:bg-legacyPrimary-600 shadow-sm",
  },
};
                    ...
                    {[
                      ...
                      <button
                        ...
                        className={`w-full text-left px-3 py-2 text-xs font-medium transition-colors flex items-center gap-2 ${
                          theme === value ? ui.dropdownItemActive : ui.dropdownItemIdle
                        }`}
                      >
              ...
              {[
                ...
                <button
                  ...
                  className={`w-full text-left px-3 py-2 rounded-lg text-xs font-medium transition-colors flex items-center gap-2 ${
                    theme === value ? ui.dropdownItemActive : ui.mobileLinkIdle
                  }`}
                >
                  {Icon ? <Icon size={14} /> : <span className="w-3 h-3 rounded-full bg-gradient-to-r from-blue-600 to-cyan-500" />}
                  {label}
