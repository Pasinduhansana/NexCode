...
function FeaturedProjectCard({ project, idx, onNavigate }) {
  return (
    <motion.article
      ...
      className="group relative flex flex-col rounded-3xl border border-border bg-card overflow-hidden cursor-pointer
    ...
    >
      ...
      <div className="relative z-20 p-5 flex flex-col flex-1">
        <h3
          className="font-extrabold text-[15px] text-foreground mb-1.5 group-hover:text-primary transition-colors duration-200 line-clamp-1"
          style={{ fontFamily: "'Syne', sans-serif" }}
        >
          {project.name}
        </h3>
        <p className="text-xs text-muted-foreground leading-relaxed mb-4 line-clamp-2 flex-1">{project.summary}</p>
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-10 md:mb-14">
          <div className="text-center md:text-left">
            ...
            <motion.h2
              ...
              className="section-title mb-4 text-center md:text-left"
            >
              Our <span className="gradient-text">Selected</span> Projects
            </motion.h2>
            ...
            <motion.p
              ...
              className="section-subtitle mx-auto md:mx-0 max-w-md"
            >
              A glimpse into the platforms, dashboards, and products we've engineered end-to-end.
            </motion.p>
          </div>
          ...
          >
            <Button variant="outline" size="sm" to="/showcase" rightIcon={<HiArrowRight size={15} />}>
              Explore More
            </Button>
          </motion.div>
        </div>
