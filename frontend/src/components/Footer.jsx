  ...
  return (
    <footer className="bg-background text-foreground border-t border-border/40">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-14">
        <div className="rounded-[2rem] bg-muted/55 ring-1 ring-border/40 backdrop-blur-sm px-5 sm:px-8 lg:px-10 py-8 sm:py-10 shadow-[0_24px_60px_rgba(15,23,42,0.06)]">
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-12 gap-10 xl:gap-8">
            ...
            <div className="xl:col-span-4">
              ...
              <div className="space-y-2.5">
                <a href="tel:+94753125140" className={`flex items-center gap-2.5 text-sm ${themeClasses.text.secondary} hover:text-primary transition-colors`}>
                  <FaPhone size={12} className="text-primary" />
                  +94 75 312 5140
                </a>
                <a href="https://wa.me/94769747244" target="_blank" rel="noreferrer" className={`flex items-center gap-2.5 text-sm ${themeClasses.text.secondary} hover:text-accent transition-colors`}>
                  <FaWhatsapp size={12} className="text-accent" />
                  +94 76 974 7244
                </a>
                <a href="https://nexcode.lk" target="_blank" rel="noreferrer" className={`flex items-center gap-2.5 text-sm ${themeClasses.text.secondary} hover:text-accent transition-colors`}>
            ...
            <div className="xl:col-span-2">
              ...
              <ul className="space-y-2.5">
                {services.map((s) => (
                  <li key={s}>
                    <Link to="/services" className={`text-sm ${themeClasses.text.secondary} hover:text-primary transition-all inline-flex items-center gap-2 group`}>
            ...
            <div className="xl:col-span-3">
              ...
              <ul className="space-y-2.5">
                {quickLinks.map((l) => (
                  <li key={l.path}>
                    <Link to={l.path} className={`text-sm ${themeClasses.text.secondary} hover:text-primary transition-all inline-flex items-center gap-2 group`}>
            ...
            <div className="xl:col-span-3">
              ...
              <div className="flex flex-wrap items-center gap-2.5 mt-3">
                {[FaLinkedin, FaTwitter, FaInstagram, FaGithub].map((Icon, i) => (
                  <a key={i} href="#" className="w-9 h-9 rounded-xl flex items-center justify-center text-sm transition-all duration-200 bg-card ring-1 ring-border/30 text-text_muted hover:bg-primary hover:text-white hover:ring-primary/20">
                    <Icon size={12} />
                  </a>
                ))}
              </div>
          ...
          <div className={`mt-8 pt-5 border-t border-border/40 flex flex-col sm:flex-row items-center justify-between gap-3`}>
            <p className={`text-xs ${themeClasses.text.secondary} opacity-80 text-center sm:text-left`}>© {new Date().getFullYear()} NexCode Software Development. All rights reserved.</p>
            <div className="flex flex-wrap items-center justify-center gap-4 text-xs">
              <a href="#" className={`${themeClasses.text.secondary} hover:text-primary transition-colors`}>Privacy Policy</a>
              <a href="#" className={`${themeClasses.text.secondary} hover:text-primary transition-colors`}>Terms of Service</a>
            </div>
          </div>
        </div>
      </div>
